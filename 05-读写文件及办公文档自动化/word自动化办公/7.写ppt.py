...
def makePPT(path):
    ...
    #创建页  参数1为页数（从1开始）   参数2为模板类型
    page1 =  pptFile.Slides.Add(1,1)
    t1 = page1.Shapes[0].TextFrame.TextRange
    t1.Text = "sunck"
    t2 = page1.Shapes[1].TextFrame.TextRange
    t2.Text = "sunck is a good man"
    #t3 = page1.Shapes[2].TextFrame.TextRange
    #t3.Text = "sunck is a good man"
...
path = path = r"C:\Users\Zhangyadi\Desktop\project\115word自动化办公\ppt.sunck.ppt"
makePPT(path)